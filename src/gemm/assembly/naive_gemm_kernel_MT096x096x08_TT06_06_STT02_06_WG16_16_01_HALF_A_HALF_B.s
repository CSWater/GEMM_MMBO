...
.text
.p2align 8
.amdgpu_hsa_kernel naive_gemm_kernel_MT096x096x08_TT06_06_STT02_06_WG16_16_01_HALF_A_HALF_B
...
ds_read_b128 v[vgprValuA_X0_I0+0:vgprValuA_X0_I0+3], v[vgprLocalReadAddrA] offset:\base+768*\iter+0
.endm

.macro DS_READ_1A base, iter
ds_read_b128 v[vgprValuA_X0_I0+4:vgprValuA_X0_I0+7], v[vgprLocalReadAddrA] offset:\base+768*\iter+256
.endm

.macro DS_READ_2A base,iter
ds_read_b128 v[vgprValuA_X0_I0+8:vgprValuA_X0_I0+11], v[vgprLocalReadAddrA] offset:\base+768*\iter+512
.endm
...
MAC_X0_6x6_UP
GLOBAL_READ_INC_ADDRESS
DS_READ_2A 0,0           //1 lds_read_b128
DS_READ_B1 0,1           //3 lds_read_b128
s_waitcnt lgkmcnt(4)
MAC_X0_6x6_MID
DS_READ_0A 0,1
s_waitcnt lgkmcnt(4)
