...
.text
.p2align 8
.amdgpu_hsa_kernel naive_gemm_kernel_MT096x096x08_TT06_06_STT03_06_WG16_16_01_NN
...
buffer_load_dwordx2 v[vgprG2LB+2:vgprG2LB+3], v[vgprGROB], s[sgprSrdB:sgprSrdB+3], s[sgprOffset0], offen offset:0
buffer_load_dwordx2 v[vgprG2LB+4:vgprG2LB+5], v[vgprGROB], s[sgprSrdB:sgprSrdB+3], s[sgprOffset1], offen offset:0
.endm
...
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+0:vgprG2LB+1] offset:\base+0x0
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+2:vgprG2LB+3] offset:\base+0x100
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+4:vgprG2LB+5] offset:\base+0x200
.endm
/******************************************/
/* 6x6 thread-tile                        */
/******************************************/
...
s_add_u32  s[sgprSrdB+0], s[sgprSrdB+0], 64 // gra SRD += inc(lower)
...
v_lshrrev_b32 v[vtmp1], 0x3, v[vgprSerial]             //serial / 8
v_mul_lo_u32 v[vgprGROB], s[sgprLdb], v[vtmp1]         // * LDB
v_and_b32 v[vtmp1], 0x7, v[vgprSerial]                 //serial % 8
v_add_lshl_u32 v[vgprGROB], v[vgprGROB], v[vtmp1], 0x3 //globalReadOffsetB_0_0_0_0, in bytes
s_mul_i32 s[sgprOffset0], s[sgprLdb], 0x100
s_mul_i32 s[sgprOffset1], s[sgprLdb], 0x200
...
v_and_b32 v[vtmp1], 0x7, v[vgprSerial]  //serial % 8
v_mul_u32_u24 v[vtmp1], 0x60, v[vtmp1]
v_lshrrev_b32 v[vtmp2], 0x3, v[vgprSerial] //serial / 8
//v_mov_b32 v[vgprLocalWriteAddrB], v[vgprSerial]
v_add_lshl_u32 v[vgprLocalWriteAddrB], v[vtmp1], v[vtmp2], 0x3
